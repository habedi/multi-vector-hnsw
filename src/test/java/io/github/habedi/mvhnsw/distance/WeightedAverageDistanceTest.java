...
class WeightedAverageDistanceTest {
        ...
        assertThrows(
                ...
                () ->
                        new WeightedAverageDistance(
                                createDistancesList(), new float[] {1.0f, -0.5f}));
    }
    ...
    void testComputeWithIdenticalVectors() {
        List<FloatVector> vectors1 =
                List.of(FloatVector.of(1.0f, 2.0f), FloatVector.of(3.0f, 4.0f));
    ...
    void testComputeWithDifferentVectors() {
        List<FloatVector> vectors1 =
                List.of(FloatVector.of(1.0f, 2.0f), FloatVector.of(1.0f, 0.0f));
        List<FloatVector> vectors2 =
                List.of(FloatVector.of(4.0f, 6.0f), FloatVector.of(0.0f, 1.0f));
